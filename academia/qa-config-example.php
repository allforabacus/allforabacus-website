...
*/
	...
	define('QA_MYSQL_HOSTNAME', 'allforabacus.com'); // try '127.0.0.1' or 'localhost' if MySQL on same server
	define('QA_MYSQL_USERNAME', 'allfo9or_abacus');
	define('QA_MYSQL_PASSWORD', 'turingmachine1');
	define('QA_MYSQL_DATABASE', 'allfo9or_qa');
