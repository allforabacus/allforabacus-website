...
define('WP_POST_VIEWS_TABLE_OLD', $table_prefix . 'post_views');
...
function add_post_views_contextual_help(){
   ...
   add_contextual_help( 'dashboard_page_post-views',
   		__('<p><a href="http://ziming.org/dev/post-views" target="_blank">Plugin Home Page</a>
   		&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; <a href="http://ziming.org/dev/post-views/usage" target="_blank">Usage</a>
   		&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; <a href="http://ziming.org/dev/post-views/qanda" target="_blank">Q & A</a>
   		&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; <a href="http://ziming.org/dev/post-views/changelog" target="_blank">ChangeLog</a>
   		&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; <a href="http://ziming.org/dev/post-views/translation" target="_blank">Translation</a></p>
...
function check_post_views_install(){ 
  ...
  $post_views_table_exists = false;
  $post_views_table_old_exists = false;
...
/************************ Check which table not exist *********************/
  ...
  foreach ( $tables as $table ){
      foreach ( $table as $value ){
	    		...
	    		if ($value == WP_POST_VIEWS_TABLE_OLD){
	    				$post_views_table_old_exists = true;
	    		}
  		}
  }
  ...
  if(!$post_views_table_exists){
      ...
      if(!$post_views_table_old_exists){
      		...
      		if(count($old_robotviews_data)){
      				foreach ( $old_robotviews_data as $old_robotviews ){
      					  $wpdb->get_results("insert into ".WP_POST_VIEWS_TABLE." set post_id = ".$old_robotviews->post_id.", view_type= 'robot',output_type = 'content', post_views_today = 0, post_views_week = 0, post_views_month = 0, post_views_halfyear = 0, post_views_year = 0, post_views_total = ".$old_robotviews->meta_value.", latest_view_time='".gmdate("Y-n-d H:i:s")."'");	
      				}
      		}
      }
  }
  ...
  if(!$post_views_his_table_exists){
   	...
   	$sql = "insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, view_type ='normal', year_id =".get_year().", output_type = 'content', post_views_today ='-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear ='-1', post_views_year = '-1'";
		$wpdb->get_results($sql);
		
		$sql = "insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, view_type ='robot', year_id =".get_year().", output_type = 'content', post_views_today ='-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear ='-1', post_views_year = '-1'";
		$wpdb->get_results($sql);
		
		$sql = "insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, view_type ='normal', year_id =".get_year().", output_type = 'excerpt', post_views_today ='-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear ='-1', post_views_year = '-1'";
		$wpdb->get_results($sql);
		
		$sql = "insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, view_type ='robot', year_id =".get_year().", output_type = 'excerpt', post_views_today ='-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear ='-1', post_views_year = '-1'";
		$wpdb->get_results($sql);
		
		$sql = "insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, view_type ='normal_coverage', year_id =".get_year().", output_type = 'content', post_views_today ='-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear ='-1', post_views_year = '-1'";
		$wpdb->get_results($sql);
		
		$sql = "insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, view_type ='robot_coverage', year_id =".get_year().", output_type = 'content', post_views_today ='-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear ='-1', post_views_year = '-1'";
		$wpdb->get_results($sql);
		
		$sql = "insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, view_type ='normal_coverage', year_id =".get_year().", output_type = 'excerpt', post_views_today ='-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear ='-1', post_views_year = '-1'";
		$wpdb->get_results($sql);
		
		$sql = "insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, view_type ='robot_coverage', year_id =".get_year().", output_type = 'excerpt', post_views_today ='-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear ='-1', post_views_year = '-1'";
		$wpdb->get_results($sql);
  ...
  $pv_fix_process = get_option('post_views_fix_process');
  if($pv_fix_process['fix_process'] != 'fixed'){
  	if($post_views_table_old_exists){
  			$sql_1 = 'INSERT INTO '.WP_POST_VIEWS_HIS_TABLE.' (SELECT 2011,OLD.post_id,OLD.view_type,OLD.output_type,-1,-1,-1,-1,-1 FROM '.WP_POST_VIEWS_TABLE_OLD.' OLD WHERE (OLD.post_id,OLD.view_type,OLD.output_type) NOT IN ( SELECT post_id,view_type,output_type FROM '.WP_POST_VIEWS_TABLE.')) ';
				$wpdb->get_results($sql_1);
				$sql_2 = 'INSERT INTO '.WP_POST_VIEWS_TABLE.' (SELECT post_id,view_type,output_type,0,0,0,0,0,post_views_total,latest_view_time FROM '.WP_POST_VIEWS_TABLE_OLD.' WHERE ('.WP_POST_VIEWS_TABLE_OLD.'.post_id,'.WP_POST_VIEWS_TABLE_OLD.'.view_type,'.WP_POST_VIEWS_TABLE_OLD.'.output_type) NOT IN ( SELECT post_id,view_type,output_type FROM '.WP_POST_VIEWS_TABLE.'))';		
  			$wpdb->get_results($sql_2);
  			$sql_3 = 'UPDATE '.WP_POST_VIEWS_TABLE.' NEW SET NEW.post_views_total = NEW.post_views_total + (SELECT OLD.post_views_total FROM '.WP_POST_VIEWS_TABLE_OLD.' OLD WHERE OLD.post_id = NEW.post_id AND OLD.view_type = NEW.view_type AND OLD.output_type = NEW.output_type) WHERE (NEW.post_id,NEW.view_type,NEW.output_type) IN ( SELECT post_id,view_type,output_type FROM '.WP_POST_VIEWS_TABLE_OLD.')';
  			$wpdb->get_results($sql_3);

  			$pv_fix_process['fix_process'] = 'fixed';
  			if(!update_option('post_views_fix_process', $pv_fix_process)){
    				add_option('post_views_fix_process',$pv_fix_process);
  			}
  	} 
  }
  //update
  $sql = "insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, view_type ='normal_viewed', year_id =".get_year().", output_type = 'content', post_views_today ='-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear ='-1', post_views_year = '-1'";
	$wpdb->get_results($sql);
		
	$sql = "insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, view_type ='robot_viewed', year_id =".get_year().", output_type = 'content', post_views_today ='-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear ='-1', post_views_year = '-1'";
	$wpdb->get_results($sql);
		
	$sql = "insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, view_type ='normal_viewed', year_id =".get_year().", output_type = 'excerpt', post_views_today ='-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear ='-1', post_views_year = '-1'";
	$wpdb->get_results($sql);
		
	$sql = "insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, view_type ='robot_viewed', year_id =".get_year().", output_type = 'excerpt', post_views_today ='-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear ='-1', post_views_year = '-1'";
	$wpdb->get_results($sql);
...
function post_views(){
	...
	if($_GET['pv_page'] == 'content-analytics' ) post_views_analytics();
	else if($_GET['pv_page'] == 'summary' ) 	post_views_summary();
	else if($_GET['pv_page'] == 'ranking' )   post_views_list();				
	else if($_GET['pv_page'] == 'analytics' ) post_views_analytics();					
	else if($_GET['pv_page'] == 'options' )   post_views_options();
	else if($_GET['pv_page'] == 'detail' )   post_views_detail();	
...
function get_time_diff($time1, $time2){
	...
	if ($diff<1){
		return $diff.' '.__('right now','post-views');
	}else{
		if ($diff<60){
	 			if($diff == 1){
...
function get_post_viewed_coverage($view_type = 'normal',$time_span = 'total',$output_type = 'content',$direction = '+',$percent = ''){
	global $wpdb;
	$post_count = $wpdb->get_var($wpdb->prepare("SELECT count(ID) FROM ".WP_POST_TABLE." where post_date < '".current_time('mysql')."' AND post_status = 'publish' AND post_password = ''"));
...
$pv_menu = "
							...
							<a href=\"".PV_ADMIN_URL."&pv_page=ranking\">".__('Ranking List','post-views')."</a> 
	            ";
...
<?php
  ...
  $today_coverage_trend =  get_post_viewed_coverage_trend($view_type,'today',$output_type);
  ...
  $week_coverage_trend =  get_post_viewed_coverage_trend($view_type,'week',$output_type);
  $week_coverage_trend_str = get_graphy_str($week_coverage_trend,get_post_viewed_coverage($view_type,'week',$output_type,'+','100'),100);
  
  $month_coverage_trend =  get_post_viewed_coverage_trend($view_type,'month',$output_type);
...
?>	
	...
	<tr>				
				...
				<th class="manage-column" scope="col" colspan="3"><?php _e('Viewed Coverage Trend (%)','post-views') ?></th>
	</tr>
	</thead>
	<tr>
	...
	<thead>
	<tr>				
				<th class="manage-column" scope="col"><?php _e('Viewed Coverage ( Week )','post-views') ?></th>
				<th class="manage-column" scope="col" colspan="3"><?php _e('Viewed Coverage Trend (%)','post-views') ?></th>
	</tr>
	</thead>
	<tr>
	...
	<thead>
	<tr>	<th class="manage-column" scope="col" ><?php _e('Viewed Coverage ( Month )','post-views') ?></th>
				<th class="manage-column" scope="col"  colspan="3"><?php _e('Viewed Coverage Trend (%)','post-views') ?></th>
	</tr>
	</thead>
	<tr>
	...
	<thead>
	<tr>				
				<th class="manage-column" scope="col"><?php _e('Viewed Coverage ( Half Year )','post-views') ?></th>
				<th class="manage-column" scope="col"><?php _e('Viewed Coverage ( Year )','post-views') ?></th>
				<th class="manage-column" scope="col"><?php _e('Viewed Coverage ( Total )','post-views') ?></th>
				<th class="manage-column" scope="col"><?php _e('Viewes Summary','post-views') ?></th>
	</tr>
	</thead>
	<tr>
...
<?php
	...
	$today_trend =  get_post_views_trend($view_type,'today',$output_type);
	$week_trend =  get_post_views_trend($view_type,'week',$output_type);
	$month_trend =  get_post_views_trend($view_type,'month',$output_type);
	$halfyear_trend =  get_post_views_trend($view_type,'halfyear',$output_type);
	$year_trend =  get_post_views_trend($view_type,'year',$output_type);
  ...
  $halfyear_trend_str= get_graphy_str($halfyear_trend,$halfyear_sum);
  $year_trend_str= get_graphy_str($year_trend,$year_sum);
  
?>
	<thead>
	<tr>				
				<th class="manage-column" scope="col" colspan="4"><?php _e('Views Summation ( Day )','post-views') ?></th>
	</tr>
	</thead>
	<tr>
	...
	<thead>
	<tr>				
				<th class="manage-column" scope="col" colspan="4"><?php _e('Views Summation ( Week )','post-views') ?></th>
	</tr>
	</thead>
	<tr>
		...
		<thead>
	<tr>				
				<th class="manage-column" scope="col" colspan="4"><?php _e('Views Summation ( Month )','post-views') ?></th>
	</tr>
	</thead>
	<tr>
	...
	<thead>
	<tr>				
				<th class="manage-column" scope="col" colspan="2"><?php _e('Views Summation ( Half Year )','post-views') ?></th>
				<th class="manage-column" scope="col" colspan="2"><?php _e('Views Summation ( Year )','post-views') ?></th>
	</tr>
	</thead>
	<tr>
...
<?php	
	...
	$today_trend =  get_post_viewed_count_trend($view_type,'today',$output_type);
	$week_trend =  get_post_viewed_count_trend($view_type,'week',$output_type);
	$month_trend =  get_post_viewed_count_trend($view_type,'month',$output_type);
	$halfyear_trend =  get_post_viewed_count_trend($view_type,'halfyear',$output_type);
	$year_trend =  get_post_viewed_count_trend($view_type,'year',$output_type);
  ...
  $halfyear_trend_str= get_graphy_str($halfyear_trend,$halfyear_count);
  $year_trend_str= get_graphy_str($year_trend,$year_count);
  
?>
	<thead>
	<tr>				
				<th class="manage-column" scope="col" colspan="4"><?php _e('Viewed Posts ( Day )','post-views') ?></th>
	</tr>
	</thead>
	<tr>
				<td colspan="4"><img src="http://chart.apis.google.com/chart?chs=1000x200&amp;chxt=x,y&amp;chco=206582&amp;chxr=1,0,<?php echo $today_trend_str['max_str']; ?>&amp;chds=0,<?php echo $today_trend_str['max_str']; ?>&amp;chxl=0:<?php echo $today_trend_str['label_str']; ?>&amp;cht=lc&amp;<?php echo $today_trend_str['chm'];?>&amp;chd=t:<?php echo $today_trend_str['data_str']; ?>" alt="" width="100%" height="200" >
	...
	<thead>
	<tr>				
				<th class="manage-column" scope="col" colspan="4"><?php _e('Viewed Posts ( Week )','post-views') ?></th>
	</tr>
	</thead>
	<tr>
				<td colspan="4"><img src="http://chart.apis.google.com/chart?chs=1000x180&amp;chxt=x,y&amp;chco=206582&amp;chxr=1,0,<?php echo $week_trend_str['max_str']; ?>&amp;chds=0,<?php echo $week_trend_str['max_str']; ?>&amp;chxl=0:<?php echo $week_trend_str['label_str']; ?>&amp;cht=lc&amp;<?php echo $week_trend_str['chm'];?>&amp;chd=t:<?php echo $week_trend_str['data_str']; ?>" alt="" width="100%" height="180" >
		...
		<thead>
	<tr>				
				<th class="manage-column" scope="col" colspan="4"><?php _e('Viewed Posts ( Month )','post-views') ?></th>
	</tr>
	</thead>
	<tr>
				<td colspan="4"><img src="http://chart.apis.google.com/chart?chs=1000x180&amp;chxt=x,y&amp;chco=206582&amp;chxr=1,0,<?php echo $month_trend_str['max_str']; ?>&amp;chds=0,<?php echo $month_trend_str['max_str']; ?>&amp;chxl=0:<?php echo $month_trend_str['label_str']; ?>&amp;cht=lc&amp;<?php echo $month_trend_str['chm'];?>&amp;chd=t:<?php echo $month_trend_str['data_str']; ?>" alt="" width="100%" height="180" ></td>
	...
	<thead>
	<tr>				
				<th class="manage-column" scope="col" colspan="2"><?php _e('Viewed Posts ( Half Year )','post-views') ?></th>
				<th class="manage-column" scope="col" colspan="2"><?php _e('Viewed Posts ( Year )','post-views') ?></th>
	</tr>
	</thead>
	<tr>
				<td colspan="2"><img src="http://chart.apis.google.com/chart?chs=500x180&amp;chxt=x,y&amp;chco=206582&amp;chxr=1,0,<?php echo $halfyear_trend_str['max_str']; ?>&amp;chds=0,<?php echo $halfyear_trend_str['max_str']; ?>&amp;chxl=0:<?php echo $halfyear_trend_str['label_str']; ?>&amp;cht=lc&amp;<?php echo $halfyear_trend_str['chm'];?>&amp;chd=t:<?php echo $halfyear_trend_str['data_str']; ?>" alt="" width="100%" height="180" ></td>
...
$sql= "SELECT DISTINCT ".WP_POST_VIEWS_TABLE.".* FROM ".WP_POST_VIEWS_TABLE." 
...
$arc_query = $wpdb->prepare("SELECT DISTINCT YEAR(post_date) AS yyear, MONTH(post_date) AS mmonth FROM $wpdb->posts ORDER BY post_date DESC");
...
<div class="wrap">
<?php screen_icon('users');?>
<h2><?php _e('Ranking List','post-views');?></h2>
<?php
$pv_menu = "
							<a href=\"".PV_ADMIN_URL."&pv_page=analytics\">".__('Analytics', 'post-views')."</a> &nbsp;|&nbsp;
							<a href=\"".PV_ADMIN_URL."&pv_page=summary\">".__('Summary','post-views')."</a> &nbsp;|&nbsp;
...
<?php
	...
	$today_trend =  get_post_views_trend($view_type,'today',$output_type,$post_id);
	$week_trend =  get_post_views_trend($view_type,'week',$output_type,$post_id);
	$month_trend =  get_post_views_trend($view_type,'month',$output_type,$post_id);
	$halfyear_trend =  get_post_views_trend($view_type,'halfyear',$output_type,$post_id);
	$year_trend =  get_post_views_trend($view_type,'year',$output_type,$post_id);
	...
	$halfyear_views = get_post_views($view_type,'halfyear',$output_type,false,$post_id,false);
	$year_views = get_post_views($view_type,'year',$output_type,false,$post_id,false);
  ...
  $halfyear_trend_str= get_graphy_str($halfyear_trend,$halfyear_views);
  $year_trend_str= get_graphy_str($year_trend,$year_views);
...
?>
	...
	<tr>
			...
			<th class="manage-column" scope="col" colspan="3"><?php _e('Views Trend','post-views') ?></th>
	</tr>
	</thead>
	<tr>
	...
	<thead>
	<tr>				
			<th class="manage-column" scope="col" colspan="2"><?php _e('Views Trend ( Half Year )','post-views') ?></th>
			<th class="manage-column" scope="col" colspan="2"><?php _e('Views Trend ( Year )','post-views') ?></th>
	</tr>
	</thead>
	<tr>
			<td colspan="2"><img src="http://chart.apis.google.com/chart?chs=500x180&amp;chxt=x,y&amp;chco=206582&amp;chxr=1,0,<?php echo $halfyear_trend_str['max_str']; ?>&amp;chds=0,<?php echo $halfyear_trend_str['max_str']; ?>&amp;chxl=0:<?php echo $halfyear_trend_str['label_str']; ?>&amp;cht=lc&amp;<?php echo $halfyear_trend_str['chm'];?>&amp;chd=t:<?php echo $halfyear_trend_str['data_str']; ?>" alt="" width="100%" height="180" ></td>
...
function post_views_last_viewed_update($id = '',$o_type){
		...
		if(!empty($id)){
				$last_visited_time['normal'][$o_type] = $wpdb->get_var($wpdb->prepare("SELECT latest_view_time FROM ".WP_POST_VIEWS_TABLE." where view_type='normal'and output_type='".$o_type."' and post_id=".$id));
				$last_visited_time['robot'][$o_type] = $wpdb->get_var($wpdb->prepare("SELECT latest_view_time FROM ".WP_POST_VIEWS_TABLE." where view_type='robot' and output_type='".$o_type."' and post_id=".$id));
		}
}

function post_view_trigger_update($v_type,$id,$o_type){
	global $wpdb;
	$having_record = $wpdb->get_var($wpdb->prepare("SELECT latest_view_time FROM ".WP_POST_VIEWS_TABLE." where view_type='".$v_type."' and output_type='".$o_type."' and post_id=".$id));
	$current_year = get_year();
	
	$max_latest_view_time = $wpdb->get_var($wpdb->prepare("SELECT max(latest_view_time) FROM ".WP_POST_VIEWS_TABLE));
	$max_year = $wpdb->get_var($wpdb->prepare("SELECT max(year_id) FROM ".WP_POST_VIEWS_HIS_TABLE));
	...
	if($max_time_span['diff_d']){
		...
		if($pv_update_process['update_process'] != 'waiting'){  // synchro mark begin
				...
				if($max_time_span['diff_d']){
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." htb set post_views_today = concat(concat(post_views_today,','),(select post_views_today from ".WP_POST_VIEWS_TABLE." tb where tb.post_id = htb.post_id AND tb.view_type = htb.view_type AND tb.output_type = htb.output_type )) where htb.post_id!= 0 AND htb.year_id = ".$current_year);
            //update today views sum
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_today = concat(post_views_today,',".get_post_views_sum('normal','today','content')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'normal' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_today = concat(post_views_today,',".get_post_views_sum('normal','today','excerpt')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'normal' AND output_type = 'excerpt' ");

						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_today = concat(post_views_today,',".get_post_views_sum('robot','today','content')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'robot' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_today = concat(post_views_today,',".get_post_views_sum('robot','today','excerpt')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'robot' AND output_type = 'excerpt' ");
	
	          //update today views coverage
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_today = concat(post_views_today,',".get_post_viewed_coverage('normal','today','content','+','100')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'normal_coverage' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_today = concat(post_views_today,',".get_post_viewed_coverage('normal','today','excerpt','+','100')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'normal_coverage' AND output_type = 'excerpt' ");

						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_today = concat(post_views_today,',".get_post_viewed_coverage('robot','today','content','+','100')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'robot_coverage' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_today = concat(post_views_today,',".get_post_viewed_coverage('robot','today','excerpt','+','100')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'robot_coverage' AND output_type = 'excerpt' ");

	
		        //update today post viewed
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_today = concat(post_views_today,',".get_post_viewed_count('normal','today','content')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'normal_viewed' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_today = concat(post_views_today,',".get_post_viewed_count('normal','today','excerpt')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'normal_viewed' AND output_type = 'excerpt' ");

						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_today = concat(post_views_today,',".get_post_viewed_count('robot','today','content')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'robot_viewed' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_today = concat(post_views_today,',".get_post_viewed_count('robot','today','excerpt')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'robot_viewed' AND output_type = 'excerpt' ");
				...
				if($max_time_span['diff_w']){
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." htb set post_views_week = concat(concat(post_views_week,','),(select post_views_week from ".WP_POST_VIEWS_TABLE." tb where tb.post_id = htb.post_id AND tb.view_type = htb.view_type AND tb.output_type = htb.output_type )) where htb.post_id!= 0 AND htb.year_id = ".$current_year);

						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_week = concat(post_views_week,',".get_post_views_sum('normal','week','content')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'normal' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_week = concat(post_views_week,',".get_post_views_sum('normal','week','excerpt')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'normal' AND output_type = 'excerpt' ");

						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_week = concat(post_views_week,',".get_post_views_sum('robot','week','content')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'robot' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_week = concat(post_views_week,',".get_post_views_sum('robot','week','excerpt')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'robot' AND output_type = 'excerpt' ");


						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_week = concat(post_views_week,',".get_post_viewed_coverage('normal','week','content','+','100')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'normal_coverage' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_week = concat(post_views_week,',".get_post_viewed_coverage('normal','week','excerpt','+','100')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'normal_coverage' AND output_type = 'excerpt' ");

						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_week = concat(post_views_week,',".get_post_viewed_coverage('robot','week','content','+','100')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'robot_coverage' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_week = concat(post_views_week,',".get_post_viewed_coverage('robot','week','excerpt','+','100')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'robot_coverage' AND output_type = 'excerpt' ");

		        //update week post viewed
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_week = concat(post_views_week,',".get_post_viewed_count('normal','week','content')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'normal_viewed' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_week = concat(post_views_week,',".get_post_viewed_count('normal','week','excerpt')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'normal_viewed' AND output_type = 'excerpt' ");

						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_week = concat(post_views_week,',".get_post_viewed_count('robot','week','content')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'robot_viewed' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_week = concat(post_views_week,',".get_post_viewed_count('robot','week','excerpt')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'robot_viewed' AND output_type = 'excerpt' ");
				...
				if($max_time_span['diff_m']){
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." htb set post_views_month = concat(concat(post_views_month,','),(select post_views_month from ".WP_POST_VIEWS_TABLE." tb where tb.post_id = htb.post_id AND tb.view_type = htb.view_type AND tb.output_type = htb.output_type )) where htb.post_id!= 0 AND htb.year_id = ".$current_year);
						
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_month = concat(post_views_month,',".get_post_views_sum('normal','month','content')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'normal' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_month = concat(post_views_month,',".get_post_views_sum('normal','month','excerpt')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'normal' AND output_type = 'excerpt' ");
						
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_month = concat(post_views_month,',".get_post_views_sum('robot','month','content')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'robot' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_month = concat(post_views_month,',".get_post_views_sum('robot','month','excerpt')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'robot' AND output_type = 'excerpt' ");
							
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_month = concat(post_views_month,',".get_post_viewed_coverage('normal','month','content','+','100')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'normal_coverage' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_month = concat(post_views_month,',".get_post_viewed_coverage('normal','month','excerpt','+','100')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'normal_coverage' AND output_type = 'excerpt' ");
						
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_month = concat(post_views_month,',".get_post_viewed_coverage('robot','month','content','+','100')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'robot_coverage' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_month = concat(post_views_month,',".get_post_viewed_coverage('robot','month','excerpt','+','100')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'robot_coverage' AND output_type = 'excerpt' ");

		        //update month post viewed
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_month = concat(post_views_month,',".get_post_viewed_count('normal','month','content')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'normal_viewed' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_month = concat(post_views_month,',".get_post_viewed_count('normal','month','excerpt')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'normal_viewed' AND output_type = 'excerpt' ");

						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_month = concat(post_views_month,',".get_post_viewed_count('robot','month','content')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'robot_viewed' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_month = concat(post_views_month,',".get_post_viewed_count('robot','month','excerpt')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'robot_viewed' AND output_type = 'excerpt' ");
				...
				if($max_time_span['diff_hy']){
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." htb set post_views_halfyear = concat(concat(post_views_halfyear,','),(select post_views_halfyear from ".WP_POST_VIEWS_TABLE." tb where tb.post_id = htb.post_id AND tb.view_type = htb.view_type AND tb.output_type = htb.output_type )) where htb.post_id!= 0  AND htb.year_id = ".$current_year);
				
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_halfyear = concat(post_views_halfyear,',".get_post_views_sum('normal','halfyear','content')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'normal' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_halfyear = concat(post_views_halfyear,',".get_post_views_sum('normal','halfyear','excerpt')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'normal' AND output_type = 'excerpt' ");
						
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_halfyear = concat(post_views_halfyear,',".get_post_views_sum('robot','halfyear','content')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'robot' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_halfyear = concat(post_views_halfyear,',".get_post_views_sum('robot','halfyear','excerpt')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'robot' AND output_type = 'excerpt' ");
									
									
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_halfyear = concat(post_views_halfyear,',".get_post_viewed_coverage('normal','halfyear','content','+','100')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'normal_coverage' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_halfyear = concat(post_views_halfyear,',".get_post_viewed_coverage('normal','halfyear','excerpt','+','100')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'normal_coverage' AND output_type = 'excerpt' ");
						
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_halfyear = concat(post_views_halfyear,',".get_post_viewed_coverage('robot','halfyear','content','+','100')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'robot_coverage' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_halfyear = concat(post_views_halfyear,',".get_post_viewed_coverage('robot','halfyear','excerpt','+','100')."') where post_id = 0 AND year_id =".$current_year." AND view_type = 'robot_coverage' AND output_type = 'excerpt' ");

				    //update halfyear post viewed
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_halfyear = concat(post_views_halfyear,',".get_post_viewed_count('normal','halfyear','content')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'normal_viewed' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_halfyear = concat(post_views_halfyear,',".get_post_viewed_count('normal','halfyear','excerpt')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'normal_viewed' AND output_type = 'excerpt' ");

						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_halfyear = concat(post_views_halfyear,',".get_post_viewed_count('robot','halfyear','content')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'robot_viewed' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_halfyear = concat(post_views_halfyear,',".get_post_viewed_count('robot','halfyear','excerpt')."') where post_id = 0 AND year_id = ".$current_year." AND view_type = 'robot_viewed' AND output_type = 'excerpt' ");
				...
				if($max_time_span['diff_y']){
						...
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_year = '".get_post_views_sum('normal','year','content')."' where post_id = 0 AND year_id =".$max_year." AND view_type = 'normal' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_year = '".get_post_views_sum('normal','year','excerpt')."' where post_id = 0 AND year_id =".$max_year." AND view_type = 'normal' AND output_type = 'excerpt' ");
						
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_year = '".get_post_views_sum('robot','year','content')."' where post_id = 0 AND year_id =".$max_year." AND view_type = 'robot' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_year = '".get_post_views_sum('robot','year','excerpt')."' where post_id = 0 AND year_id =".$max_year." AND view_type = 'robot' AND output_type = 'excerpt' ");

						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_year = '".get_post_viewed_coverage('normal','year','content','+','100')."' where post_id = 0 AND year_id =".$max_year." AND view_type = 'normal_coverage' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_year = '".get_post_viewed_coverage('normal','year','excerpt','+','100')."' where post_id = 0 AND year_id =".$max_year." AND view_type = 'normal_coverage' AND output_type = 'excerpt' ");
						
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_year = '".get_post_viewed_coverage('robot','year','content','+','100')."' where post_id = 0 AND year_id =".$max_year." AND view_type = 'robot_coverage' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_year = '".get_post_viewed_coverage('robot','year','excerpt','+','100')."' where post_id = 0 AND year_id =".$max_year." AND view_type = 'robot_coverage' AND output_type = 'excerpt' ");

				    //update year post viewed
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_year = '".get_post_viewed_count('normal','year','content')."' where post_id = 0 AND year_id = ".$max_year." AND view_type = 'normal_viewed' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_year = '".get_post_viewed_count('normal','year','excerpt')."' where post_id = 0 AND year_id = ".$max_year." AND view_type = 'normal_viewed' AND output_type = 'excerpt' ");

						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_year = '".get_post_viewed_count('robot','year','content')."' where post_id = 0 AND year_id = ".$max_year." AND view_type = 'robot_viewed' AND output_type = 'content' ");
						$wpdb->get_results("update ".WP_POST_VIEWS_HIS_TABLE." set post_views_year = '".get_post_viewed_count('robot','year','excerpt')."' where post_id = 0 AND year_id = ".$max_year." AND view_type = 'robot_viewed' AND output_type = 'excerpt' ");

						
						$wpdb->get_results("insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, year_id =".$current_year.", view_type = 'normal', output_type='content', post_views_today = '-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear = '-1', post_views_year = '-1' ");
						$wpdb->get_results("insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, year_id =".$current_year.", view_type = 'normal', output_type='excerpt', post_views_today = '-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear = '-1', post_views_year = '-1' ");
					
						$wpdb->get_results("insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, year_id =".$current_year.", view_type = 'robot', output_type='content', post_views_today = '-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear = '-1', post_views_year = '-1' ");
						$wpdb->get_results("insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, year_id =".$current_year.", view_type = 'robot', output_type='excerpt', post_views_today = '-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear = '-1', post_views_year = '-1' ");

						$wpdb->get_results("insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, year_id =".$current_year.", view_type = 'normal_coverage', output_type='content', post_views_today = '-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear = '-1', post_views_year = '-1' ");
						$wpdb->get_results("insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, year_id =".$current_year.", view_type = 'normal_coverage', output_type='excerpt', post_views_today = '-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear = '-1', post_views_year = '-1' ");
					
						$wpdb->get_results("insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, year_id =".$current_year.", view_type = 'robot_coverage', output_type='content', post_views_today = '-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear = '-1', post_views_year = '-1' ");
						$wpdb->get_results("insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, year_id =".$current_year.", view_type = 'robot_coverage', output_type='excerpt', post_views_today = '-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear = '-1', post_views_year = '-1' ");

						$wpdb->get_results("insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, year_id =".$current_year.", view_type = 'normal_viewed', output_type='content', post_views_today = '-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear = '-1', post_views_year = '-1' ");
						$wpdb->get_results("insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, year_id =".$current_year.", view_type = 'normal_viewed', output_type='excerpt', post_views_today = '-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear = '-1', post_views_year = '-1' ");
					
						$wpdb->get_results("insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, year_id =".$current_year.", view_type = 'robot_viewed', output_type='content', post_views_today = '-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear = '-1', post_views_year = '-1' ");
						$wpdb->get_results("insert into ".WP_POST_VIEWS_HIS_TABLE." set post_id = 0, year_id =".$current_year.", view_type = 'robot_viewed', output_type='excerpt', post_views_today = '-1', post_views_week = '-1', post_views_month = '-1', post_views_halfyear = '-1', post_views_year = '-1' ");
...
function get_post_views_list($mode = '', $view_type = 'normal', $output_type = 'content', $time_span = 'total', $order_type = 'views', $order_by = 'DESC', $limit = 10, $chars = 0, $category_id = 0, $tag_id = 0){
		...
		if($post_viewed) {
			foreach ($post_viewed as $post) {
				...
				$pv_views[$count] = array('title' => '<a href="'.get_permalink().'"  class="with_bottom_a" >'.$post_title.'</a>', 'views' => number_format($post_views), 'time' => $view_time, 'post_id' => $post->ID );
				$count++;
			}
		}
		return $pv_views;
...
function get_post_views($view_type = 'normal',$timespan = 'total',$output_type = 'content',$format = false,$post_id = '',$by_cache = false) {
	global $wpdb,$post;
	if(empty($post_id)){
		$post_id = $post->ID;		
	}
  ...
  if(!empty($pv_rec_options)){
	...
	$views =  intval($wpdb->get_var($wpdb->prepare("SELECT post_views_".$timespan." FROM ".WP_POST_VIEWS_TABLE." where view_type= '".$view_type."' and output_type= '".$output_type."' and post_id=".$post_id)));
	
	if(is_cache() && !$by_cache && $real_time_views){
		 	$cache_views  = "";
...
function get_post_views_time($v_type = 'normal', $o_type = 'content', $format = 'Y-m-d H:i:s'){
...
function get_post_viewed_count($view_type,$time_span,$output_type){
  ...
  $count = $wpdb->get_var($wpdb->prepare("SELECT count(post_id) FROM ".WP_POST_VIEWS_TABLE." where view_type='".$view_type."' and output_type='".$output_type."' and ".$time_span." !=0"));
	return $count;
}

function get_post_views_trend($view_type,$time_span,$output_type,$post_id = 0){
	global $wpdb;
	$time_span = "post_views_".$time_span;
  $trend = $wpdb->get_var($wpdb->prepare("SELECT ".$time_span." FROM ".WP_POST_VIEWS_HIS_TABLE." where view_type='".$view_type."' and output_type='".$output_type."' and year_id=".get_year()." and post_id=".$post_id));
	return  $trend;
}

function get_post_viewed_count_trend($view_type,$time_span,$output_type,$post_id = 0){
	global $wpdb;
	$time_span = "post_views_".$time_span;
  $trend = $wpdb->get_var($wpdb->prepare("SELECT ".$time_span." FROM ".WP_POST_VIEWS_HIS_TABLE." where view_type='".$view_type."_viewed' and output_type='".$output_type."' and year_id=".get_year()." and post_id=0"));
	return  $trend;
}

function get_post_viewed_coverage_trend($view_type,$time_span,$output_type){
	global $wpdb;
	$time_span = "post_views_".$time_span;
  $trend = $wpdb->get_var($wpdb->prepare("SELECT ".$time_span." FROM ".WP_POST_VIEWS_HIS_TABLE." where view_type='".$view_type."_coverage' and output_type='".$output_type."' and year_id=".get_year()." and post_id=0"));
	return  $trend;
}
...
function get_post_last_viewed_time($format){
  return get_post_views_time('normal','content',$format);
}

function get_post_last_previewed_time($format){
  return get_post_views_time('normal','excerpt',$format);
}

function get_post_last_robotviewed_time($format){
  return get_post_views_time('robot','content',$format);
}

function get_post_last_robotpreviewed_time($format){
  return get_post_views_time('robot','excerpt',$format);
}
